...
public SearchResultRecord() {
  ...
  public SearchResultRecord(IFeedRecord record) {
    ...
    _fullDescription = record.getAbstract();
...
//    _defaultGeometry = false; 
 ...
 // Strip out xml/html characters
  ...
  public String getFullDescription() {
    return Val.chkStr(_fullDescription);
  }
    /**
   * Sets the description.
   * @param abs the full abstract
   */
  public void setFullDescription(String abs) {
    _fullDescription = Val.chkStr(abs);
 // Strip out xml/html characters
    this._fullDescription = _fullDescription.replaceAll("\\<.*?\\>", "");
