...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:res="http://www.esri.com/metadata/res/" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:esri="http://www.esri.com/metadata/" xmlns:exslt="http://exslt.org/common" >
...
<div class="box arcgis">
  ...
  <div><a name="TopArcGIS" id="TopArcGIS"/></div>
	...
	<xsl:if test="/metadata/dataIdInfo[1]/tpCat | /metadata/dataIdInfo[1]/discKeys | /metadata/dataIdInfo[1]/placeKeys | /metadata/dataIdInfo[1]/stratKeys | /metadata/dataIdInfo[1]/tempKeys | /metadata/dataIdInfo[1]/themeKeys | /metadata/dataIdInfo[1]/productKeys | /metadata/dataIdInfo[1]/subTopicCatKeys | /metadata/dataIdInfo[1]/otherKeys | /metadata/Esri/DataProperties/itemProps/imsContentType">
		<xsl:variable name="sectionHeading"><xsl:value-of select="fn:string('TopicsAndKeywords')" /></xsl:variable>
		...
		<xsl:variable name="eleID"><xsl:value-of select="generate-id(exslt:node-set($elements1)/*[not(thesaName)][1]) or generate-id(exslt:node-set($elements1b))" /></xsl:variable>
	...
	<xsl:for-each select="/metadata/dataIdInfo[1]/idCitation">
		<xsl:call-template name="tocSectionArcGIS">
			<xsl:with-param name="sectionHeading"><xsl:value-of select="fn:string('idCitation')"/></xsl:with-param>
		</xsl:call-template>
	</xsl:for-each>
	
	<xsl:if test="/metadata/dataIdInfo[1]/idCitation/citRespParty">
		<xsl:variable name="sectionHeading"><xsl:value-of select="fn:string('CitationContacts')"/></xsl:variable>
	...
	<xsl:for-each select="/metadata/Esri/locales">
		<xsl:call-template name="tocSectionArcGIS">
			<xsl:with-param name="sectionHeading"><xsl:value-of select="fn:string('ESRILocales')"/></xsl:with-param>
		</xsl:call-template>
	</xsl:for-each>
	...
	<xsl:if test="/metadata/Esri/DataProperties/itemProps | /metadata/dataIdInfo[1]/dataLang | /metadata/dataIdInfo[1]/dataChar | /metadata/dataIdInfo[1]/idStatus | /metadata/dataIdInfo[1]/spatRpType | /metadata/dataIdInfo[1]/dsFormat | /metadata/dataIdInfo[1]/dataScale | /metadata/dataIdInfo[1]/graphOver | /metadata/dataIdInfo[1]/suppInfo | /metadata/dataIdInfo[1]/envirDesc | /metadata/dataIdInfo[1]/idCredit | /metadata/dataIdInfo[1]/idSpecUse">
		<xsl:variable name="sectionHeading"><xsl:value-of select="fn:string('ResourceDetails')" /></xsl:variable>
		...
		<xsl:variable name="eleID"><xsl:value-of select="generate-id(exslt:node-set($elements4)/node()[1])" /></xsl:variable>
		<xsl:variable name="show"><xsl:value-of select="concat($eleID, 'Show')" /></xsl:variable>
		<xsl:variable name="hide"><xsl:value-of select="concat($eleID, 'Hide')" /></xsl:variable>
		<h2 class="iso">
			<a onclick="hideShow('{$eleID}')" href="#{$eleID}">
	...
	<xsl:if test="/metadata/dataIdInfo[1]/svType | /metadata/dataIdInfo[1]/svTypeVer | /metadata/dataIdInfo[1]/svAccProps | /metadata/dataIdInfo[1]/svCouplRes | /metadata/dataIdInfo[1]/svCouplType | /metadata/dataIdInfo[1]/svOper | /metadata/Esri/Server | /metadata/Esri/Service | /metadata/Esri/ServiceType | /metadata/Esri/ServiceFCType | /metadata/Esri/ServiceFCName">
		<xsl:variable name="sectionHeading"><xsl:value-of select="fn:string('ServiceDetails')" /></xsl:variable>
		...
		<xsl:variable name="eleID"><xsl:value-of select="generate-id(exslt:node-set($elements8)/node()[1])" /></xsl:variable>
		<xsl:variable name="show"><xsl:value-of select="concat($eleID, 'Show')" /></xsl:variable>
		<xsl:variable name="hide"><xsl:value-of select="concat($eleID, 'Hide')" /></xsl:variable>
		<h2 class="iso">
			<a onclick="hideShow('{$eleID}')" href="#{$eleID}">
	...
	<xsl:if test="/metadata/dataIdInfo[1]/dataExt | /metadata/Esri/DataProperties/itemProps/nativeExtBox">
		<xsl:variable name="sectionHeading"><xsl:value-of select="fn:string('Extents')"/></xsl:variable>
		<xsl:variable name="elements7" select="/metadata/dataIdInfo[1]/dataExt | /metadata/Esri/DataProperties/itemProps/nativeExtBox"/>
		<xsl:variable name="eleID"><xsl:value-of select="generate-id(exslt:node-set($elements7)/node()[1])" /></xsl:variable>
		<xsl:variable name="show"><xsl:value-of select="concat($eleID, 'Show')" /></xsl:variable>
		<xsl:variable name="hide"><xsl:value-of select="concat($eleID, 'Hide')" /></xsl:variable>
		<h2 class="iso">
			<a onclick="hideShow('{$eleID}')" href="#{$eleID}">
	...
	<xsl:if test="/metadata/dataIdInfo[1]/idPoC">
		<xsl:variable name="sectionHeading"><xsl:value-of select="fn:string('ResourcePointsOfContact')"/></xsl:variable>
	...
	<xsl:if test="/metadata/dataIdInfo[1]/resMaint">
		<xsl:variable name="sectionHeading"><xsl:value-of select="fn:string('ResourceMaintenance')"/></xsl:variable>
	...
	<xsl:if test="/metadata/dataIdInfo[1]/resConst">
		<xsl:variable name="sectionHeading"><xsl:value-of select="fn:string('ResourceConstraints')"/></xsl:variable>
	...
	<xsl:if test="/metadata/refSysInfo | /metadata/Esri/DataProperties/coordRef">
		<xsl:variable name="sectionHeading"><xsl:value-of select="fn:string('ReferenceSystem')"/></xsl:variable>
		<xsl:variable name="elements6" select="/metadata/refSysInfo | /metadata/Esri/DataProperties/coordRef"/>
		<xsl:variable name="eleID"><xsl:value-of select="generate-id(exslt:node-set($elements6)/node()[1])" /></xsl:variable>
		<xsl:variable name="show"><xsl:value-of select="concat($eleID, 'Show')" /></xsl:variable>
		<xsl:variable name="hide"><xsl:value-of select="concat($eleID, 'Hide')" /></xsl:variable>
		<h2 class="iso">
			<a onclick="hideShow('{$eleID}')" href="#{$eleID}">
	...
	<xsl:if test="/metadata/spatRepInfo | /metadata/spdoinfo/ptvctinf/esriterm | /metadata/Esri/DataProperties/topoinfo | /metadata/Esri/DataProperties/Terrain | /metadata/spdoinfo/netinfo | /metadata/Esri/Locator | /metadata/Esri/DataProperties/RasterProperties">
		<xsl:variable name="sectionHeading"><xsl:value-of select="fn:string('SpatialRepresentation')"/></xsl:variable>
		...
		<xsl:variable name="eleID"><xsl:value-of select="generate-id(exslt:node-set($elements5)/node()[1])" /></xsl:variable>
		<xsl:variable name="show"><xsl:value-of select="concat($eleID, 'Show')" /></xsl:variable>
		<xsl:variable name="hide"><xsl:value-of select="concat($eleID, 'Hide')" /></xsl:variable>
		<h2 class="iso">
			<a onclick="hideShow('{$eleID}')" href="#{$eleID}">
	...
	<xsl:if test="/metadata/contInfo[not(name(*) = 'ContInfo')]">
		<xsl:variable name="sectionHeading"><xsl:value-of select="fn:string('ContentInformation')"/></xsl:variable>
	...
	<xsl:if test="/metadata/dqInfo/dqScope | /metadata/dqInfo/report">
		<xsl:variable name="sectionHeading"><xsl:value-of select="fn:string('DataQuality')"/></xsl:variable>
		<xsl:variable name="elements9" select="/metadata/dqInfo/dqScope | /metadata/dqInfo/report"/>
		<xsl:variable name="eleID"><xsl:value-of select="generate-id(exslt:node-set($elements9)/node()[1])" /></xsl:variable>
		<xsl:variable name="show"><xsl:value-of select="concat($eleID, 'Show')" /></xsl:variable>
		<xsl:variable name="hide"><xsl:value-of select="concat($eleID, 'Hide')" /></xsl:variable>
		<h2 class="iso">
			<a onclick="hideShow('{$eleID}')" href="#{$eleID}">
	...
	<xsl:if test="/metadata/dqInfo/dataLineage">
		<xsl:variable name="sectionHeading"><xsl:value-of select="fn:string('dataLineage')"/></xsl:variable>
	...
	<xsl:for-each select="/metadata/Esri/DataProperties/lineage">
		<xsl:call-template name="tocSectionArcGIS">
			<xsl:with-param name="sectionHeading"><xsl:value-of select="fn:string('ESRIGeoprocessingHistory')"/></xsl:with-param>
		</xsl:call-template>
	</xsl:for-each>
	
	<xsl:for-each select="/metadata/distInfo">
		<xsl:call-template name="tocSectionArcGIS">
			<xsl:with-param name="sectionHeading"><xsl:value-of select="fn:string('DistributionInformation')"/></xsl:with-param>
		</xsl:call-template>
	</xsl:for-each>
	
	<xsl:for-each select="/metadata/eainfo">
		<xsl:call-template name="tocSectionArcGIS">
			<xsl:with-param name="sectionHeading"><xsl:value-of select="fn:string('ESRIFieldsAndSubtypes')"/></xsl:with-param>
		</xsl:call-template>
	</xsl:for-each>
	
	<xsl:if test="/metadata/dataIdInfo[1]/aggrInfo | /metadata/appSchInfo | /metadata/porCatInfo/portCatCit">
		<xsl:variable name="sectionHeading"><xsl:value-of select="fn:string('References')"/></xsl:variable>
		<xsl:variable name="elements3" select="/metadata/dataIdInfo[1]/aggrInfo | /metadata/appSchInfo | /metadata/porCatInfo/portCatCit"/>
		<xsl:variable name="eleID"><xsl:value-of select="generate-id(exslt:node-set($elements3)/node()[1])" /></xsl:variable>
		<xsl:variable name="show"><xsl:value-of select="concat($eleID, 'Show')" /></xsl:variable>
		<xsl:variable name="hide"><xsl:value-of select="concat($eleID, 'Hide')" /></xsl:variable>
		<h2 class="iso">
			<a onclick="hideShow('{$eleID}')" href="#{$eleID}">
	...
	<xsl:if test="/metadata/mdFileID | /metadata/mdLang | /metadata/mdChar | /metadata/mdParentID | /metadata/mdHrLv | /metadata/mdHrLvName | /metadata/mdDateSt | /metadata/dataSetURI | /metadata/dataSetFn | /metadata/Esri/ArcGISFormat | /metadata/Esri/ArcGISstyle | /metadata/Esri/ArcGISProfile | /metadata/Esri/CreaDate | /metadata/Esri/CreaTime | /metadata/Esri/ModDate | /metadata/Esri/ModTime | /metadata/Esri/SyncDate | /metadata/Esri/SyncTime | /metadata/Esri/SyncOnce | /metadata/Esri/MapLyrSync | /metadata/Esri/Sync | /metadata/Esri/Identifier | /metadata/Esri/PublishedDocID | /metadata/Esri/PublishStatus | /metadata/Esri/DataProperties/copyHistory">
		<xsl:variable name="sectionHeading"><xsl:value-of select="fn:string('MetadataDetails')"/></xsl:variable>
		<xsl:variable name="elements2" select="/metadata/mdFileID | /metadata/mdLang | /metadata/mdChar | /metadata/mdParentID | /metadata/mdHrLv | /metadata/mdHrLvName | /metadata/mdDateSt | /metadata/dataSetURI | /metadata/dataSetFn | /metadata/Esri/ArcGISFormat | /metadata/Esri/ArcGISstyle | /metadata/Esri/ArcGISProfile | /metadata/Esri/CreaDate | /metadata/Esri/CreaTime | /metadata/Esri/ModDate | /metadata/Esri/ModTime | /metadata/Esri/SyncDate | /metadata/Esri/SyncTime | /metadata/Esri/SyncOnce | /metadata/Esri/MapLyrSync | /metadata/Esri/Sync | /metadata/Esri/Identifier | /metadata/Esri/PublishedDocID | /metadata/Esri/PublishStatus | /metadata/Esri/DataProperties/copyHistory"/>
		<xsl:variable name="eleID"><xsl:value-of select="generate-id(exslt:node-set($elements2)/node()[1])" /></xsl:variable>
		<xsl:variable name="show"><xsl:value-of select="concat($eleID, 'Show')" /></xsl:variable>
		<xsl:variable name="hide"><xsl:value-of select="concat($eleID, 'Hide')" /></xsl:variable>
		<h2 class="iso">
			<a onclick="hideShow('{$eleID}')" href="#{$eleID}">
	...
	<xsl:if test="/metadata/mdContact">
		<xsl:variable name="sectionHeading"><xsl:value-of select="fn:string('MetadataContacts')"/></xsl:variable>
	...
	<xsl:if test="/metadata/mdMaint">
		<xsl:variable name="sectionHeading"><xsl:value-of select="fn:string('MetadataMaintenance')"/></xsl:variable>
	...
	<xsl:if test="/metadata/mdConst">
		<xsl:variable name="sectionHeading"><xsl:value-of select="fn:string('MetadataConstraints')"/></xsl:variable>
	...
	<xsl:if test="/metadata/mdExtInfo">
		<xsl:variable name="sectionHeading"><xsl:value-of select="fn:string('MetadataExtensions')"/></xsl:variable>
	...
	<xsl:for-each select="/metadata/Binary">
		<xsl:call-template name="tocSectionArcGIS">
			<xsl:with-param name="sectionHeading"><xsl:value-of select="fn:string('ESRIThumbnailsAndEnclosures')"/></xsl:with-param>
		</xsl:call-template>
	</xsl:for-each>
...
<!-- ESRI-ISO elements not included -->
...
<xsl:template match="/metadata/Esri/DataProperties/lineage" mode="arcgis">
      <xsl:for-each select="Process">
        ...
        <dl>
          ...
          <dt><span class="esriElement"><res:ProcessCommandIssued /></span></dt>
          <dl>
		  ...
		  <xsl:choose>
			  ...
			  <xsl:otherwise>
				<dt><span class="esriElement"><res:ProcessExport/></span>&#x2003;No</dt>
			  </xsl:otherwise>
		  </xsl:choose>
          <br /><br />
        </dl>
...
<xsl:template name="ArcGISmetadata">
	<xsl:for-each select="/metadata/Esri">
        ...
        <dl>
			<dt><span class="esriElement"><res:metadataFormat /></span>&#x2003;<xsl:choose>
			...
			<xsl:if test="SyncDate | SyncTime | SyncOnce | MapLyrSync">
				...
				<dl>	
					...
					<!-- ESRI-ISO no longer supports turning off synchronization for an item because of user problems it caused -->
					<!--
			...
			<!-- ESRI-ISO metadata identifier, this one can't be guaranteed to be unique -->
			<!--
		...
		<xsl:for-each select="peXml">
			...
			<xsl:choose>
				<xsl:when test="function-available('esri:decodenodeset')">
					...
					<dl>
						<xsl:apply-templates select="exslt:node-set($pestring)" mode="pexml" />
					</dl>
				</xsl:when>
	...
	<div class="show" id="{$eleID}">
		<dl>
			...
			<xsl:for-each select="topoRule">
				<dt><xsl:call-template name="arcgisElementName">
						<xsl:with-param name="ele" select="."></xsl:with-param>
					</xsl:call-template><span class="esriElement"><xsl:value-of select="position()" /></span></dt>
				<dl>
...
<xsl:template name="esriFeatureClass">
	<xsl:if test="(./*)">
		...
		<div class="show" id="{$eleID}">
			...
			<div class="backToTop"><a onclick="hideShow('{$eleID}')" href="#{$eleID}"><res:idHide />&#160;<xsl:call-template name="elementText">
				<xsl:with-param name="ele" select="/metadata/spdoinfo/ptvctinf/esriterm" />
			</xsl:call-template>&#160;&#9650;</a></div>
		</div><br/><br/>
	</xsl:if>
</xsl:template>
		  ...
		  <xsl:choose>
			  <xsl:when test="@code">
				<dt><xsl:if test="@Sync = 'TRUE'">
					...
					</span>&#x2003;<xsl:call-template name="GeometryTypeCode">
			  ...
			  <!-- ESRI-ISO uses a text value, ArcGIS uses the enum code; both still work in ArcGIS -->
			  <xsl:when test="(. != '')">
				<xsl:call-template name="arcgisElement">
					<xsl:with-param name="ele" select="."></xsl:with-param>
				</xsl:call-template>
		...
		<xsl:choose>
			<xsl:when test="attr or subtype">
				...
				<a onclick="hideShow('{$eleID}')" href="#{$eleID}">
					<dt><span class="esriElement"><xsl:call-template name="elementText">
							<xsl:with-param name="ele" select="." />
						</xsl:call-template></span>&#160;<xsl:value-of select="$objectName"/>&#160;
					<span id="{$show}" class="hide">&#9660;</span><span id="{$hide}" class="show">&#9658;</span></dt>
				</a>
				<div class="show" id="{$eleID}">
					<dl>
					  ...
					  <xsl:if test="(enttyp/enttypt | enttyp/enttypc | enttyp/enttypd | enttyp/enttypds)"><br /><br /></xsl:if>
					  
					  <xsl:call-template name="fieldsAndSubtypes" />
					</dl>
					<div class="backToTop"><a onclick="hideShow('{$eleID}')" href="#{$eleID}"><res:idHide />&#160;<xsl:call-template name="elementText">
							<xsl:with-param name="ele" select="." />
						</xsl:call-template>&#160;<xsl:value-of select="$objectName"/>&#160;&#9650;</a></div>
				</div><br/><br/>
			</xsl:when>
			<xsl:otherwise>
				<dt><xsl:call-template name="arcgisElementName">
...
<xsl:template name="fieldsAndSubtypes">
  <xsl:for-each select="attr">
	...
	<a onclick="hideShow('{$eleID}')" href="#{$eleID}">
		<dt><span class="esriElement"><xsl:call-template name="elementText">
				<xsl:with-param name="ele" select="." />
			</xsl:call-template></span>&#160;<xsl:value-of select="$fieldName"/></dt>&#160;
		<span id="{$show}" class="hide">&#9660;</span><span id="{$hide}" class="show">&#9658;</span>
	</a>
	<div class="show" id="{$eleID}">
		<dl>
		...
		<div class="backToTop"><a onclick="hideShow('{$eleID}')" href="#{$eleID}"><res:idHide />&#160;<xsl:call-template name="elementText">
				<xsl:with-param name="ele" select="." />
			</xsl:call-template>&#160;<xsl:value-of select="$fieldName"/>&#160;&#9650;</a></div>
	</div><br/><br/>
  </xsl:for-each>
</xsl:template>
