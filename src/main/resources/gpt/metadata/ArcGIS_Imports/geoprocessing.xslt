<?xml version="1.0"?>
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:res="http://www.esri.com/metadata/res/"
xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:esri="http://www.esri.com/metadata/" xmlns:msxsl="urn:schemas-microsoft-com:xslt" >
...
-->
	...
	<xsl:template match="/metadata/Binary/Thumbnail/img[@src]" mode="gp">
		<xsl:variable name="label" select="fn:string('idIllus')" />
	...
	<xsl:template match="/metadata/Binary/Enclosure/img[(@src != '') and (esri:strtolower(@OriginalFileName) = 'thumbnail.jpg')]" mode="gp">
		<xsl:variable name="label" select="fn:string('idSidePanelIllus')" />
