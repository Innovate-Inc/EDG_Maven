...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
                xmlns:dt="urn:schemas-microsoft-com:datatypes" xmlns:res="http://www.esri.com/metadata/res/" xmlns:fn="http://www.w3.org/2005/xpath-functions" 
...
<xsl:template match="node()[node()=10]">
  <div class="e"><span>
  <span class="b">&#160;</span>
  <span class="d">&lt;!DOCTYPE <xsl:value-of select="name()"/><I> (<res:idViewSrcForDoctype/>)</I>&gt;</span>
  </span></div>
</xsl:template>
